...
.main_grid_border .main_grid_row_head .main_grid_cell_head:first-child{border-left:1px solid #C1EAF9;}
...
.main_grid_compact .main_grid_cell_head_container{padding:9px 10px;}
.main_grid_compact .main_grid_head_title{font-size:13px;}
...
.main_grid_compact .main_grid_cell_sortable_down{padding-right:21px;}
.main_grid_cell_sortable{background-color:#c1eaf9;}
...
.main_grid_cell_sortable_down:hover:before{ opacity:.6;}
.main_grid_cell{
  background: #ffffff;
  vertical-align: top;
  padding:0;
...
.main_grid_cell_left   {text-align:left;}
...
.main_grid_row         .main_grid_cell:last-child{ border-right:none;}
.main_grid_border        .main_grid_cell{
  border-right: 1px solid #edeef0 !important;
  border-bottom:1px solid #edeef0 !important;
}
.main_grid_border .main_grid_row .main_grid_cell:first-child{border-left:1px solid #edeef0;}
...
.main_grid_cell_foot .main_grid_cell_content{padding:10px 13px 22px;}
.main_grid_compact .main_grid_cell_foot .main_grid_cell_content{padding:10px 10px 15px;}
...
textarea.main_grid_cell_content_edit{height:auto;}
input[type="file"].main_grid_cell_content_edit{display:none;}
...
.main_grid_compact  .main_grid_cell_content{padding:10px 10px 8px;}
...
.main_grid_cell_center {text-align:center;}
.main_grid_cell_right  {text-align:right;}
.main_grid_cell_justify{text-align:justify;}
...
.kb_disk_object_name{width:100%}.kb_disk_object_name tr td{padding:0!important;border:none!important;max-width:180px;text-overflow:ellipsis;overflow:hidden}
.kb_disk_folder_icon.double{position:relative;top:-6px;width:40px;height:35px;background:url(images/sprite.png)0 -1120px!important}
.kb_disk_interface_tile .kb_disk_folder_icon{display:block;float:none;margin:30px auto 10px}
